 ...
 * undecided when it comes to modern art, but we consider going if there is a
 * museum about Andy Warhol (because we do like him) or if it's a modern art
 * museum conveniently located in nearby Amsterdam. All other museums we'd
 * rather skip.
 *
 * We tried to implement these preferences in a function, so we can automatically
 * sort through long lists of museums and find the ones that sound interesting.
 * However, our Boolean check is flawed, as it fails some of our test cases.
 * Can you fix it?
 */
