...
// The shift method removes the first element from an array and returns that
// element; if the array is empty, shift returns undefined.
function shift(array) {
  return array.splice(0, 1).pop();
}

// The unshift method adds one or more elements to the start of an array and
...
console.log(unshift(testArray, 5, 6)); // 4
console.log(testArray); // [5, 6, 2, 3]
